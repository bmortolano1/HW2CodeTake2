...
if __name__ == '__main__':
    ...
    # Part D - Size 2
    bag.perform_random_forests(3, bank_table_test, bank_table_train, 100, bank_attributes, bank_attribute_values, 1500, 250,
                        False, True, "Part4Data2-2.txt", 2)

    # Part D - Size 4
    bag.perform_random_forests(3, bank_table_test, bank_table_train, 100, bank_attributes, bank_attribute_values, 1500,
                               250,
                               False, True, "Part4Data4-2.txt", 4)

    # Part D - Size 6
    bag.perform_random_forests(3, bank_table_test, bank_table_train, 100, bank_attributes, bank_attribute_values, 1500,
                               250,
                               False, True, "Part4Data6-2.txt", 6)
